...
class _BookingPageState extends State<BookingPage> {
  ...
  String? _emailError; // Para mostrar error si el email es inválido
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // --- 0. INGRESO DE CORREO ---
              Text('0. Ingresa tu correo', style: Theme.of(context).textTheme.headlineSmall),
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(24),
                    borderSide: BorderSide(color: extremeGreen, width: 2),
                  ),
