...
import 'model/notification_service.dart'; // Para la clase Addon
...
class ConfirmationPage extends StatelessWidget {
  ...
  ConfirmationPage({
    ...
    // Se ejecuta después de que se renderiza la página
  ...
  Future<void> _sendNotification() async {
    final fechaFormatted = DateFormat('yyyy-MM-dd').format(selectedDate);
    ...
    final notification = NotificationModel(
      ...
      hora: horaFormatted,
      piloto: selectedPilot?.name ?? '',
      cargosAdicionales: selectedAddons.map((a) => a.name).join(', '),
      totalPagar: totalPrice.toString(),
      actividad: activityTitle,
      metodoPago: paymentMethodName,
    );

    try {
      bool success = await NotificationService.createNotification(notification);
      if (success) {
                ...
                Card(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                            'Detalles de la Reserva realizada en Xtreme Park',
